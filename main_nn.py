...
if arch == DQNArch.CLASSIC:
    ...
    dqn_arch = Dueling
    # network = PolicyFCDueling(env.observation_space.shape[0], 24, 12, env.action_space.n)
else:
    raise NotImplementedError

network = PolicyFC(env.observation_space.shape[0], 24, 12, env.action_space.n, dqn_arch)
